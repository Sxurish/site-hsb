    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-surface/70 backdrop-blur">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 md:px-8">
        <a href="#top" className="text-lg font-black tracking-wide">
          AGENCY<span className="text-brightCyan">_NAME</span>
        </a>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          href="#contact"
          className="hidden rounded-full bg-hotPink px-4 py-2 text-sm font-semibold text-black md:inline-flex"
        >
          Request a Quote
        </motion.a>
          ...
          >
            <div className="mx-auto flex max-w-7xl flex-col gap-2">
              ...
              <a
                href="#contact"
                onClick={() => setOpen(false)}
                className="mt-2 rounded-lg bg-hotPink px-4 py-2 text-center text-sm font-bold text-black"
              >
                Request a Quote
              </a>
            </div>
